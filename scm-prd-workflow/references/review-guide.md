...
审阅交互（审阅方式选择、问题处理、额外意见收集）统一由 `autonomous-mode.md` 的 SC-01~SC-06 定义。本节仅定义与模式无关的变更记录规范。
...
Stage C 审阅的选项化交互（SC-01~SC-06）统一定义在 `autonomous-mode.md` Stage C 章节中，本文件不再重复。
