...
| NP-01~05 | 叙事反模式自检 | writing-guide.md | 叙事规划草稿完成后、CD-01 前（静默） |
| NP-06~08 | 撰写前结构预校验 | writing-guide.md | NP-06 在 CD-01 前；NP-07~08 在 CD-01 后、撰写前 |
| NP-09~11 | 方案评估验证 | writing-guide.md | 方案评估后、CD-01 前（因果链/方案逻辑/约束消化） |
